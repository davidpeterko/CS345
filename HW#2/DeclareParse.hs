...
action_2 (6) = happyGoto action_18
...
action_21 (6) = happyGoto action_18
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenKeyword "var" -> cont 10;
	Symbol ";" -> cont 11;
	TokenIdent happy_dollar_dollar -> cont 12;
	Digits happy_dollar_dollar -> cont 13;
	Symbol "=" -> cont 14;
	Symbol "+" -> cont 15;
	Symbol "-" -> cont 16;
	Symbol "*" -> cont 17;
